  ...
  return (
    <>
      <AnimatePresence>
        {open ? (
          <motion.div
            ...
            className="panel fixed bottom-24 right-4 z-50 flex h-[min(560px,70vh)] w-[min(400px,calc(100vw-2rem))] flex-col overflow-hidden bg-[#141110]/95 sm:right-5"
          >
            ...
            >
              ...
              <button
                ...
                aria-label="Send"
                className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-[var(--color-primary)] text-[#1c0d05] transition-opacity disabled:opacity-40"
              >
      ...
      <motion.button
        ...
        aria-expanded={open}
        whileTap={{ scale: 0.94 }}
        className="fixed bottom-5 right-4 z-50 grid h-14 w-14 place-items-center rounded-full bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-secondary)] text-[#1c0d05] shadow-[0_12px_40px_-10px_var(--color-primary)] sm:right-5"
      >
