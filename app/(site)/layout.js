...
export default function SiteLayout({ children }) {
  return (
    <>
      ...
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[100] focus:rounded-lg focus:bg-[var(--color-primary)] focus:px-4 focus:py-2 focus:text-[var(--color-ink)]"
      >
        Skip to content
      </a>
      <Navbar />
